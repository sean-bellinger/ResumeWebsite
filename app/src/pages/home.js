export default function Home() {
    return <div>
        ...
        <div>
            Software Engineer with a focus on Full Stack JavaScript development, primarily with React and Node.js. <br></br>

            Strong: JavaScript (All ECMAScripts) | React | Webpack | HTML5 | CSS | Node.js | SQL | Git | Linux <br></br>

            Experienced: Kubernetes | Jira | Docker | Terraform | AWS Cloud Computing
        </div>
    </div>
}